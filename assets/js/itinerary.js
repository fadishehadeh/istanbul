...
const ITINERARY = [
...

  {
    ...
    items: [
      ...
      { time: "15:00", title: "Büyük Çamlıca Camii", note: "Fifteen minutes by taxi up from Üsküdar — the car stays at the hotel, this is easier. The largest mosque in Türkiye, finished in 2019, on the highest point in İstanbul. The terrace outside is the real reward: the whole city and both bridges laid out below you. Free. Outside prayer times, shoes off, shoulders and knees covered.", place: "camlica" },
...

  {
    ...
    items: [
      ...
      { time: "20:45", title: "T1 to Kabataş, funicular up", note: "Eminönü straight back along the shore, then F1 up to Taksim in ninety seconds. Same İstanbulkart, no changes." },
      { time: "21:00", title: "Museum of Illusions, İstiklal", note: "The anti-gravity room, the infinity tunnel, the vortex corridor. CHECK THE CLOSING TIME BEFORE YOU LEAVE EMINÖNÜ — this is an indoor daytime attraction and every evening of your week runs past sunset, so tonight is the only one that even reaches Beyoğlu in time. If it has shut, you have lost nothing: İstiklal after dark is worth the walk and you are ten minutes above the hotel.", place: "museum-illusions" }
    ],
