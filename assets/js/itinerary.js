...
const ITINERARY = [
...

  {
    ...
    items: [
      ...
      { time: "17:15", title: "Blue Mosque (Sultanahmet Camii)", note: "Two stops down the T1 from Eminönü. Six minarets, twenty thousand İznik tiles, and still a working neighbourhood mosque — free to enter. You are between Asr and Maghrib now, which is the widest gap of the day: it shuts to visitors for about half an hour around each prayer. Shoes off, shoulders and knees covered, scarves at the door.", place: "blue-mosque" },
