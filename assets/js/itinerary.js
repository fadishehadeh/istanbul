...
const ITINERARY = [
...

  {
    ...
    items: [
      ...
      { time: "20:15", title: "Back over the bridge", note: "The FSM drops you at Ayazağa on the European side, which is exactly where you are going next. Nothing you wanted today was closed on a Monday — the palaces and museums were, which is why none are here." },
...

  {
    ...
    car: { use: true, text: "Take it, and take it across on the boat — the Sirkeci car ferry to Harem puts you and the car on the water instead of on a bridge. You need it up at Çamlıca anyway." },
    subtitle: "The car ferry across, a painted village, the big mosque on the hill, and the best sunset walk in the city — looking west at the old city.",
    tags: ["Car ferry", "Bosphorus", "Sunset walk"],
    items: [
      { time: "08:45", title: "Drive to the Sirkeci car ferry", note: "Ten minutes along the shore road to the arabalı vapur ramp at Sirkeci. Cars queue on the quay and roll straight on — no booking, you pay at the barrier.", map: "Sirkeci Arabalı Vapur İskelesi Eminönü" },
      { time: "09:15", title: "Car ferry Sirkeci → Harem", note: "You and the car cross the mouth of the Bosphorus by boat rather than over a bridge — about twenty-five minutes, old city falling away behind you. Get out and stand at the rail; nobody stays in the car. CONFIRM IT IS RUNNING before you rely on it: this line has been suspended in the past. If it is not, the Bosphorus Bridge puts you in Üsküdar in twenty-five minutes anyway.", map: "Harem Arabalı Vapur İskelesi Üsküdar" },
      ...
      { time: "15:00", title: "Büyük Çamlıca Camii", note: "Fifteen minutes up the hill from Üsküdar, and the reason the car came across — there is a big free car park at the top. The largest mosque in Türkiye, finished in 2019, on the highest point in İstanbul. The terrace outside is the real reward: the whole city and both bridges laid out below you. Free. Outside prayer times, shoes off, shoulders and knees covered.", place: "camlica" },
      { time: "16:45", title: "Fethipaşa Korusu", note: "A 19th-century Ottoman grove on the hill above Üsküdar, terraced down toward the water with a restored köşk. Open 08:30–23:00, free to enter, and the closest of the Asian groves to the ferry.", map: "Fethi Paşa Korusu Üsküdar" },
      ...
      { time: "20:30", title: "Back across the water", note: "Harem to Sirkeci on the car ferry again if the late boats are still running — check the board when you land in the morning. Otherwise the Bosphorus Bridge, twenty-five minutes, with the strait lit underneath you." },
    ...
    swap: "Çamlıca is even better at dusk, with the city lighting up below the terrace — but that means giving up the Üsküdar sunset walk, and the walk is the better of the two. Beylerbeyi Palace and Küçüksu Kasrı are both open today and both on this shore if you want one building; Küçüksu is the smaller and stranger."
  },

  {
    ...
    items: [
      ...
      { time: "19:30", title: "Balık ekmek at Eminönü", note: "Downhill to the quay. Grilled mackerel in half a loaf, handed over from boats rocking at the rail beside the Galata Bridge. Squeeze the lemon, eat standing. The cheapest famous meal in İstanbul.", map: "Eminönü balık ekmek Galata Köprüsü" },
      { time: "20:00", title: "Ferry Eminönü → Kadıköy", note: "The pier is right where you are eating. Twenty minutes across the mouth of the Bosphorus in the dark, the busiest crossing in the city and still the best twenty lira you will spend. Sit outside at the back.", map: "Eminönü Kadıköy vapur iskelesi" },
      { time: "20:30", title: "Kadıköy: Çiya Sofrası and the market lanes", note: "Five minutes up from the pier. Regional Anatolian cooking that exists nowhere else and a menu that changes daily — point at what you want, it is priced by weight. Kitchen goes until 22:00. The fish market lanes around it stay busy well after that.", place: "ciya-sofrasi" },
      { time: "22:00", title: "Ferry Kadıköy → Kabataş", note: "Twenty minutes back with the old city lit on your left and the hotel a seven-minute walk from the pier. LAST BOAT IS AROUND 23:00 — check the board when you land at 20:00 so the time is in your head." }
    ],
    swap: "The Museum of Illusions on İstiklal lost its slot to the Kadıköy crossing — it shuts well before your evenings end, so it was always a gamble at 21:00. If you would rather have it, swap the two in the app: it is ten minutes above the hotel by the Kabataş funicular. Want the truly obscure version of today instead? Yedikule Bostanları — market gardens still farmed inside the 5th-century land walls, continuously for around 1,500 years. Direct on the T1 to Zeytinburnu, then a short walk, and virtually no visitors."
  },
